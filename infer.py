...
def testIm(file):
    ...
    for i, (box) in enumerate(boxes):
        ...
        cv2.putText(img, str(probs[i]), (x1,y1), cv2.FONT_HERSHEY_COMPLEX, 1.0, (0,0,255), 1)
...
if __name__ == '__main__':
    ...
    # testIm('./FDDB/originalPics/2003/02/04/big/img_143.jpg')
    # testIm('./FDDB/originalPics/2002/08/11/big/img_591.jpg')