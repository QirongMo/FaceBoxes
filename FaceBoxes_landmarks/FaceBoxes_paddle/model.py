...
class FaceBoxes(Layer):
    ...
    def forward(self, inputs):
        ...
        landmark1 = paddle.transpose(landmark1, (0, 2, 3, 1))
        landmark1 = paddle.reshape(landmark1, (N, -1, 10))
        ...
        landmark2 = paddle.transpose(landmark2, (0, 2, 3, 1))
        landmark2 = paddle.reshape(landmark2, (N, -1, 10))
        ...
        landmark3 = paddle.transpose(landmark3, (0, 2, 3, 1))
        landmark3 = paddle.reshape(landmark3, (N, -1, 10))
        ...
        landmark = paddle.concat([landmark1, landmark2, landmark3], axis=1)

        return [regression, landmark, classifier]
